...
Spring Cloud provides tools for building common distributed system patterns.

### 1.1. Key Patterns

| Pattern | Spring Cloud | Description |
|---------|-------------|-------------|
...
Adds trace ID and span ID to logs automatically:
```
